  ...
  return (
    <div className="">
      <BrowserRouter>
        ...
        <Route exact path="/" component={() => <Link to="/payin"><Button color="primary" title="Payin" name="payin" >Payin</Button></Link>} />
        <Route exact path="/" component={() => <Link to="/payout"><Button color="primary" title="Payout" name="payout" >Payout</Button></Link>} />
